...
TEST(MM2Test, FastaRefAlign)
{
    ...
    EXPECT_EQ(89, alignedFastaRefBam.size());

    std::vector<BAM::BamRecord> alignedRefFileBam = SimpleAlign();
    EXPECT_EQ(89, alignedRefFileBam.size());
