  ...
  $ ID=$(samtools view -H $CRAMTMP/split_dataset_sorted_json.3260208_188nM-GTAC_2xGCratio_LP7_100fps_15min_5kEColi_SP2p1_3uMSSB_BA243494.bam | grep 3260208_188nM-GTAC_2xGCratio_LP7_100fps_15min_5kEColi_SP2p1_3uMSSB_BA243494 | cut -f 2 | cut -f 2 -d ':')
  $ samtools view $CRAMTMP/split_dataset_sorted_json.3260208_188nM-GTAC_2xGCratio_LP7_100fps_15min_5kEColi_SP2p1_3uMSSB_BA243494.bam | grep -vc ${ID} | tr -d ' '
  0
  $ samtools view $CRAMTMP/split_dataset_sorted_json.3260208_188nM-GTAC_2xGCratio_LP7_100fps_15min_5kEColi_SP2p1_3uMSSB_BA243494.bam | wc -l | tr -d ' '
  9

  $ ID=$(samtools view -H $CRAMTMP/split_dataset_sorted_json.test_test.bam | grep test_test | cut -f 2 | cut -f 2 -d ':')
  $ samtools view $CRAMTMP/split_dataset_sorted_json.test_test.bam | grep -vc ${ID} | tr -d ' '
  0
  $ samtools view $CRAMTMP/split_dataset_sorted_json.test_test.bam | wc -l | tr -d ' '
  11

  $ ID=$(samtools view -H $CRAMTMP/split_dataset_sorted_json.UCLA_1023.bam | grep UCLA_1023 | cut -f 2 | cut -f 2 -d ':')
  $ samtools view $CRAMTMP/split_dataset_sorted_json.UCLA_1023.bam | grep -vc ${ID} | tr -d ' '
  0
  $ samtools view $CRAMTMP/split_dataset_sorted_json.UCLA_1023.bam | wc -l | tr -d ' '
  10
  ...
  1
  $ grep -c split_dataset_sorted_json.test_test.alignmentset.xml $CRAMTMP/split_dataset_sorted_json.json | tr -d ' '
  1
  $ grep -c split_dataset_sorted_json.UCLA_1023.alignmentset.xml $CRAMTMP/split_dataset_sorted_json.json | tr -d ' '
  1
