  ...
  $ "$PBMM2" align "$IN" "$REF" "$CRAMTMP"/ji_unsorted.bam
  ...
  $ "$PBMM2" align "$IN" "$REF" "$CRAMTMP"/ji_sorted.bam --sort
  ...
  $ "$PBMM2" align "$IN" "$REF" "$CRAMTMP"/ji_unsortedds.alignmentset.xml 2> "$CRAMTMP"/ji_unsortedds.err || echo $?
  ...
  $ "$PBMM2" align "$IN" "$REF" "$CRAMTMP"/ji_sortedds.alignmentset.xml --sort 2> "$CRAMTMP"/ji_sortedds.err || echo $?
  ...
  $ "$PBMM2" align "$IN" "$REF" "$CRAMTMP"/ji_unsortedjs.json
  ...
  $ "$PBMM2" align "$IN" "$REF" "$CRAMTMP"/ji_sortedjs.json --sort
  ...
  $ "$PBMM2" align "$IN" "$REF" > "$CRAMTMP"/ji_unsortedoutstream.bam
  ...
  $ "$PBMM2" align "$IN" "$REF" > "$CRAMTMP"/ji_sortedoutstream.bam --sort
  ...
  $ "$PBMM2" align median.json "$REF" "$CRAMTMP"/median_json_preset.bam --log-level INFO 2>&1 | grep "Setting to"
  *Setting to SUBREAD preset (glob)

  $ "$PBMM2" align median.subreadset.json "$REF" "$CRAMTMP"/median_json_preset.bam --log-level INFO 2>&1 | grep "Setting to"
  *Setting to SUBREAD preset (glob)

  $ "$PBMM2" align median.consensusreadset.json "$REF" "$CRAMTMP"/median_json_preset.bam --log-level INFO 2>&1 | grep "Setting to"
  *Setting to CCS preset (glob)

  $ "$PBMM2" align median.transcriptset.json "$REF" "$CRAMTMP"/median_json_preset.bam --log-level INFO 2>&1 | grep "Setting to"
