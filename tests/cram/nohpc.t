  ...
  *Homopolymer compressed : true (glob)
  $ $__PBTEST_PBMM2_EXE index $REF $CRAMTMP/index_default.mmi --log-level=DEBUG -u 2>&1 | grep "Homopolymer compressed"
  *Homopolymer compressed : false (glob)
  $ $__PBTEST_PBMM2_EXE align $IN $CRAMTMP/index_default.mmi $CRAMTMP/out_hpc.bam --log-level=DEBUG -u 2>&1 | grep "Homopolymer compressed"
  *Homopolymer compressed : false (glob)
  ...
  *Homopolymer compressed : true (glob)
  $ $__PBTEST_PBMM2_EXE align $IN $REF $CRAMTMP/out_hpc.bam --log-level=DEBUG -u 2>&1 | grep "Homopolymer compressed"
  *Homopolymer compressed : false (glob)
