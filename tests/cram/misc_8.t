  ...
  $ echo "$FASTA" >> "$CRAMTMP"/mixed-fa-fa.fofn
  $ "$PBMM2" align "$CRAMTMP"/mixed-fa-fa.fofn "$REF" "$CRAMTMP"/mixed-fa-fa.bam -j 4 --log-level INFO --preset SUBREAD 2>&1
  ...
  *Peak RSS: * (glob)
  ...
  $ echo "$FASTQGZ" >> "$CRAMTMP"/mixed-fqgz-fqgz.fofn
  $ "$PBMM2" align "$CRAMTMP"/mixed-fqgz-fqgz.fofn "$REF" "$CRAMTMP"/mixed-fqgz-fqgz.bam -j 4 --log-level INFO --preset SUBREAD 2>&1
  *Using 4 threads for alignments.* (glob)
  ...
  *Peak RSS: * (glob)
  ...
  $ echo "$FASTAGZ" >> "$CRAMTMP"/mixed-fagz-fagz.fofn
  $ "$PBMM2" align "$CRAMTMP"/mixed-fagz-fagz.fofn "$REF" "$CRAMTMP"/mixed-fagz-fagz.bam -j 4 --log-level INFO --preset SUBREAD 2>&1
  *Using 4 threads for alignments.* (glob)
  *Input is FASTA FOFN. Output BAM file cannot be used for polishing with GenomicConsensus!* (glob)
  ...
  *Peak RSS: * (glob)
  ...
  $ "$PBMM2" align "$CRAMTMP"/mixed-fqgz-fq.fofn "$REF" "$CRAMTMP"/mixed-fqgz-fq.bam -j 4 --log-level INFO --preset SUBREAD 2>&1
  *Using 4 threads for alignments.* (glob)
  *Input is FASTQ FOFN. Output BAM file cannot be used for polishing with GenomicConsensus!* (glob)
  ...
  *Peak RSS: * (glob)
  ...
  $ "$PBMM2" align "$CRAMTMP"/mixed-fa-fagz.fofn "$REF" "$CRAMTMP"/mixed-fa-fagz.bam -j 4 --log-level INFO --preset SUBREAD 2>&1
  *Using 4 threads for alignments.* (glob)
  *Input is FASTA FOFN. Output BAM file cannot be used for polishing with GenomicConsensus!* (glob)
  ...
  *Peak RSS: * (glob)
  ...
  $ echo $BAM >> "$CRAMTMP"/mixed-bam-bam.fofn
  $ "$PBMM2" align "$CRAMTMP"/mixed-bam-bam.fofn "$REF" "$CRAMTMP"/mixed-bam-bam.bam -j 4 --log-level INFO --preset SUBREAD 2>&1
  *Using 4 threads for alignments.* (glob)
